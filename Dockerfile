...
#Comando para criar o contaniner a partir de uma imagem no projeto docker: docker run -dti -p 8083:8080 --name bff-projeto-agendador nome-do-projeto
...
# -p 8086:8080 -> a porta 8080 do container será exposta para fora como porta 8086
